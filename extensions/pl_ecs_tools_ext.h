...
typedef struct _plRendererScene            plRendererScene;            // pl_renderer_ext.h
...
PL_API bool pl_ecs_tools_show_window(plComponentLibrary*, plEntity* selectedEntity, plRendererScene*, bool*);
...
typedef struct _plEcsToolsI
{
    ...
    void (*cleanup)        (void);
    bool (*show_window)(plComponentLibrary*, plEntity* selectedEntity, plRendererScene*, bool*);
} plEcsToolsI;
