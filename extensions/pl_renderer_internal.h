...
// culling
static bool pl__renderer_sat_visibility_test(plCameraComponent*, const plAABB*);
...
static void pl__renderer_generate_cascaded_shadow_map(plRenderEncoder*, plCommandBuffer*, plScene*, uint32_t, uint32_t, int, plDirectionLightShadowData*, plCameraComponent*);
