...
#define plShaderVariantI_version {0, 3, 0}
...
typedef struct _plShaderVariantI
{
    ...
    plShaderHandle          (*get_shader)                    (const char* name, const plGraphicsState*, const void* tempVtxConstantData, const void* tempFragConstantData, const plRenderAttachmentInfo*);
