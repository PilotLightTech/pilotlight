...
const char*
pl_string_intern_intern_ex(const char* pcString, plStringRepository* ptRepo)
{
...
void
pl_string_intern_remove_ex(const char* pcString, plStringRepository* ptRepo)
{
...
const char*
pl_string_intern_intern(const char* pcString)
{
    return pl_string_intern_intern_ex(pcString, NULL);
}

void
pl_string_intern_remove(const char* pcString)
{
    pl_string_intern_remove_ex(pcString, NULL);
}
...
pl_load_string_intern_ext(plApiRegistryI* ptApiRegistry, bool bReload)
{
    const plStringInternI tApi = {
        ...
        .intern_ex          = pl_string_intern_intern_ex,
        .remove_ex          = pl_string_intern_remove_ex,
