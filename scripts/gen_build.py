...
with pl.project("pilotlight"):
    ...
    pl.push_include_directories("../dependencies/stb", "../dependencies/cgltf")
    pl.push_include_directories("../apps", "../src", "../libs", "../extensions", "../out")
    ...
    with pl.target("app", pl.TargetType.DYNAMIC_LIBRARY):
        ...
        pl.push_vulkan_glsl_files("../shaders/glsl/", "grass.frag", "grass.vert")
        with pl.configuration("debug"):
            with pl.platform(pl.PlatformType.WIN32):
                with pl.compiler("msvc", pl.CompilerType.MSVC):
                    pass
