...
with pl.project("pilotlight"):
    ...
    pl.push_include_directories("../apps", "../examples", "../src", "../extensions", "../backends", "../out", "../dependencies/pilotlight-ui", "../dependencies/pilotlight-ui/backends", "../dependencies/pilotlight-libs", "../dependencies/stb", "../dependencies/cgltf")
