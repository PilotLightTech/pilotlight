...
void main() 
{
    ...
    // gl_Position = vec4(inPosition, 1.0) + vec4(tObjectInfo.tOffset, 0, 0) + vec4(inPosition, 1.0);
    gl_Position = vec4((inPosition.x + tObjectInfo.tOffset.x) * 2.0 / tGlobalInfo.iViewportWidth, (inPosition.y + tObjectInfo.tOffset.y)* 2.0 / tGlobalInfo.iViewportHeight, 0.0, 1.0);
