...
elif [ -e "../out/libpl_shader_cpu_ext.so" ]; then
echo
echo ${YELLOW}Target: pl_shader_cpu_ext${NC}
echo ${YELLOW}~~~~~~~~~~~~~~~~~~~${NC}
...
# only build once check
elif [ -e "../out/libpl_graphics_cpu_ext.so" ]; then
echo
echo ${YELLOW}Target: pl_graphics_cpu_ext${NC}
echo ${YELLOW}~~~~~~~~~~~~~~~~~~~${NC}
echo Cache: ${GREEN}Valid${NC}
...
# only build once check
elif [ -e "../out/libpl_platform_ext.so" ]; then
echo
echo ${YELLOW}Target: pl_platform_ext${NC}
echo ${YELLOW}~~~~~~~~~~~~~~~~~~~${NC}
echo Cache: ${GREEN}Valid${NC}
...
echo ${YELLOW}~~~~~~~~~~~~~~~~~~~${NC}
echo ${CYAN}Compiling and Linking...${NC}
gcc -shared $PL_SOURCES $PL_INCLUDE_DIRECTORIES $PL_DEFINES $PL_COMPILER_FLAGS $PL_INCLUDE_DIRECTORIES $PL_LINK_DIRECTORIES $PL_STATIC_LINK_LIBRARIES $PL_DYNAMIC_LINK_LIBRARIES $PL_LINKER_FLAGS -o "./../out/libpl_draw_2d_frag.so"
...
# only build once check
elif [ -e "../out/libpl_draw_2d_frag.so" ]; then
echo
echo ${YELLOW}Target: pl_draw_2d_frag${NC}
echo ${YELLOW}~~~~~~~~~~~~~~~~~~~${NC}
echo Cache: ${GREEN}Valid${NC}
...
echo ${YELLOW}~~~~~~~~~~~~~~~~~~~${NC}
echo ${CYAN}Compiling and Linking...${NC}
gcc -shared $PL_SOURCES $PL_INCLUDE_DIRECTORIES $PL_DEFINES $PL_COMPILER_FLAGS $PL_INCLUDE_DIRECTORIES $PL_LINK_DIRECTORIES $PL_STATIC_LINK_LIBRARIES $PL_DYNAMIC_LINK_LIBRARIES $PL_LINKER_FLAGS -o "./../out/libpl_draw_2d_sdf_frag.so"
...
# only build once check
elif [ -e "../out/libpl_draw_2d_sdf_frag.so" ]; then
echo
echo ${YELLOW}Target: pl_draw_2d_sdf_frag${NC}
echo ${YELLOW}~~~~~~~~~~~~~~~~~~~${NC}
echo Cache: ${GREEN}Valid${NC}
...
echo ${YELLOW}~~~~~~~~~~~~~~~~~~~${NC}
echo ${CYAN}Compiling and Linking...${NC}
gcc -shared $PL_SOURCES $PL_INCLUDE_DIRECTORIES $PL_DEFINES $PL_COMPILER_FLAGS $PL_INCLUDE_DIRECTORIES $PL_LINK_DIRECTORIES $PL_STATIC_LINK_LIBRARIES $PL_DYNAMIC_LINK_LIBRARIES $PL_LINKER_FLAGS -o "./../out/libpl_draw_2d_vert.so"
...
# only build once check
elif [ -e "../out/libpl_draw_2d_vert.so" ]; then
echo
echo ${YELLOW}Target: pl_draw_2d_vert${NC}
echo ${YELLOW}~~~~~~~~~~~~~~~~~~~${NC}
echo Cache: ${GREEN}Valid${NC}
