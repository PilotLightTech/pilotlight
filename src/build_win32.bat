...
@set PL_INCLUDE_DIRECTORIES=-I"../internal/sandbox" -I"../internal/demo" -I"../src" -I"../shaders" -I"../libs" -I"../extensions" -I"../out" -I"../dependencies/stb" -I"../dependencies/cgltf" -I"../dependencies/imgui" -I"../dependencies/glfw/include" -I"%WindowsSdkDir%Include\um" -I"%WindowsSdkDir%Include\shared" -I"%VULKAN_SDK%\Include" 
...
@set PL_DEFINES=-DPL_UNITY_BUILD -DPL_VULKAN_BACKEND -DPL_UNITY_BUILD -D_DEBUG -DPL_CONFIG_DEBUG 
@set PL_INCLUDE_DIRECTORIES=-I"../internal/sandbox" -I"../internal/demo" -I"../src" -I"../shaders" -I"../libs" -I"../extensions" -I"../out" -I"../dependencies/stb" -I"../dependencies/cgltf" -I"../dependencies/imgui" -I"../dependencies/glfw/include" -I"%WindowsSdkDir%Include\um" -I"%WindowsSdkDir%Include\shared" 
...
@set PL_INCLUDE_DIRECTORIES=-I"../internal/sandbox" -I"../internal/demo" -I"../src" -I"../shaders" -I"../libs" -I"../extensions" -I"../out" -I"../dependencies/stb" -I"../dependencies/cgltf" -I"../dependencies/imgui" -I"../dependencies/glfw/include" -I"%VULKAN_SDK%\Include" 
@set PL_LINK_DIRECTORIES=-LIBPATH:"../out" 
...
@set PL_INCLUDE_DIRECTORIES=-I"../internal/sandbox" -I"../internal/demo" -I"../src" -I"../shaders" -I"../libs" -I"../extensions" -I"../out" -I"../dependencies/stb" -I"../dependencies/cgltf" -I"../dependencies/imgui" -I"../dependencies/glfw/include" 
@set PL_LINK_DIRECTORIES=-LIBPATH:"../out" 
