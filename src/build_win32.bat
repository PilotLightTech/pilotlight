...
@if "%PL_CONFIG%" equ "test" ( goto test )
...
@echo.
@echo [1m[93mTarget: pl_unity_ext[0m
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
...
:: run compiler (and linker)
@echo.
@echo [1m[93mTarget: pl_shader_ext[0m
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
@echo [1m[36mCompiling and Linking...[0m
...
@if %PL_HOT_RELOAD_STATUS% equ 1 goto Exit_pl_shader_cpu_ext

:: only build once
@if exist "..\out\pl_shader_cpu_ext.dll" goto CacheCheck_pl_shader_cpu_ext
...
if %ERRORLEVEL% NEQ 0 (
@echo.
    @echo [1m[93mTarget: pl_shader_cpu_ext[0m
    @echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
    @echo [1mCache: [92mValid[0m
    goto Exit_pl_shader_cpu_ext
)
@echo.
@echo [1m[93mTarget: pl_shader_cpu_ext[0m
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
...
:: run compiler (and linker)
@echo.
@echo [1m[93mTarget: pl_graphics_ext[0m
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
@echo [1m[36mCompiling and Linking...[0m
...
:: skip during hot reload
@if %PL_HOT_RELOAD_STATUS% equ 1 goto Exit_pl_graphics_cpu_ext

:: only build once
@if exist "..\out\pl_graphics_cpu_ext.dll" goto CacheCheck_pl_graphics_cpu_ext
...
if %ERRORLEVEL% NEQ 0 (
@echo.
    @echo [1m[93mTarget: pl_graphics_cpu_ext[0m
    @echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
    @echo [1mCache: [92mValid[0m
    goto Exit_pl_graphics_cpu_ext
)
@echo.
@echo [1m[93mTarget: pl_graphics_cpu_ext[0m
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
...
:: run compiler (and linker)
@echo.
@echo [1m[93mTarget: pl_script_camera[0m
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
@echo [1m[36mCompiling and Linking...[0m
...
:: only build once
@if exist "..\out\pl_platform_ext.dll" goto CacheCheck_pl_platform_ext
...
if %ERRORLEVEL% NEQ 0 (
@echo.
    @echo [1m[93mTarget: pl_platform_ext[0m
    @echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
    @echo [1mCache: [92mValid[0m
    goto Exit_pl_platform_ext
)
@echo.
@echo [1m[93mTarget: pl_platform_ext[0m
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
...
:: run compiler (and linker)
@echo.
@echo [1m[93mTarget: pilot_light[0m
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
@echo [1m[36mCompiling and Linking...[0m
...
:: skip during hot reload
@if %PL_HOT_RELOAD_STATUS% equ 1 goto Exit_pl_draw_2d_frag

:: only build once
@if exist "..\out\pl_draw_2d_frag.dll" goto CacheCheck_pl_draw_2d_frag
...
if %ERRORLEVEL% NEQ 0 (
@echo.
    @echo [1m[93mTarget: pl_draw_2d_frag[0m
    @echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
    @echo [1mCache: [92mValid[0m
    goto Exit_pl_draw_2d_frag
)
@echo.
@echo [1m[93mTarget: pl_draw_2d_frag[0m
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
...
@set PL_SOURCES="../shaders/pl_draw_2d_frag.cpp" 
...
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
@echo [1m[36mCompiling and Linking...[0m
cl %PL_INCLUDE_DIRECTORIES% %PL_DEFINES% %PL_COMPILER_FLAGS% %PL_SOURCES% -Fe"../out/pl_draw_2d_frag.dll" -Fo"../out/" -LD -link %PL_LINKER_FLAGS% -PDB:"../out/pl_draw_2d_frag_%random%.pdb" %PL_LINK_DIRECTORIES%
...
:: skip during hot reload
@if %PL_HOT_RELOAD_STATUS% equ 1 goto Exit_pl_draw_2d_sdf_frag

:: only build once
@if exist "..\out\pl_draw_2d_sdf_frag.dll" goto CacheCheck_pl_draw_2d_sdf_frag
...
if %ERRORLEVEL% NEQ 0 (
@echo.
    @echo [1m[93mTarget: pl_draw_2d_sdf_frag[0m
    @echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
    @echo [1mCache: [92mValid[0m
    goto Exit_pl_draw_2d_sdf_frag
)
@echo.
@echo [1m[93mTarget: pl_draw_2d_sdf_frag[0m
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
...
@set PL_COMPILER_FLAGS=-Zc:preprocessor -nologo -std:c++14 -W4 -WX -wd4201 -wd4100 -wd4996 -wd4505 -wd4189 -wd5105 -wd4115 -permissive- -Od -MDd -Zi -TP 
@set PL_LINKER_FLAGS=-noimplib -noexp -incremental:no 
@set PL_SOURCES="../shaders/pl_draw_2d_sdf_frag.cpp" 
...
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
@echo [1m[36mCompiling and Linking...[0m
cl %PL_INCLUDE_DIRECTORIES% %PL_DEFINES% %PL_COMPILER_FLAGS% %PL_SOURCES% -Fe"../out/pl_draw_2d_sdf_frag.dll" -Fo"../out/" -LD -link %PL_LINKER_FLAGS% -PDB:"../out/pl_draw_2d_sdf_frag_%random%.pdb" %PL_LINK_DIRECTORIES%
...
:: skip during hot reload
@if %PL_HOT_RELOAD_STATUS% equ 1 goto Exit_pl_draw_2d_vert

:: only build once
@if exist "..\out\pl_draw_2d_vert.dll" goto CacheCheck_pl_draw_2d_vert
...
if %ERRORLEVEL% NEQ 0 (
@echo.
    @echo [1m[93mTarget: pl_draw_2d_vert[0m
    @echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
    @echo [1mCache: [92mValid[0m
    goto Exit_pl_draw_2d_vert
)
@echo.
@echo [1m[93mTarget: pl_draw_2d_vert[0m
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
...
@set PL_COMPILER_FLAGS=-Zc:preprocessor -nologo -std:c++14 -W4 -WX -wd4201 -wd4100 -wd4996 -wd4505 -wd4189 -wd5105 -wd4115 -permissive- -Od -MDd -Zi -TP 
@set PL_LINKER_FLAGS=-noimplib -noexp -incremental:no 
@set PL_SOURCES="../shaders/pl_draw_2d_vert.cpp" 
...
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
@echo [1m[36mCompiling and Linking...[0m
cl %PL_INCLUDE_DIRECTORIES% %PL_DEFINES% %PL_COMPILER_FLAGS% %PL_SOURCES% -Fe"../out/pl_draw_2d_vert.dll" -Fo"../out/" -LD -link %PL_LINKER_FLAGS% -PDB:"../out/pl_draw_2d_vert_%random%.pdb" %PL_LINK_DIRECTORIES%
...
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
@echo [1m[36mCompiling and Linking...[0m
cl %PL_INCLUDE_DIRECTORIES% %PL_DEFINES% %PL_COMPILER_FLAGS% %PL_SOURCES% -Fe"../out/pl_shader_ext.dll" -Fo"../out/" -LD -link %PL_LINKER_FLAGS% -PDB:"../out/pl_shader_ext_%random%.pdb" %PL_LINK_DIRECTORIES%
