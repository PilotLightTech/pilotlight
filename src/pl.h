...
#define PILOT_LIGHT_VERSION_STRING "0.11.1 WIP"
#define PILOT_LIGHT_VERSION_NUM     01101
#define PILOT_LIGHT_VERSION         {0, 11, 1}
...
typedef struct _plVersion // API version struct
{
    uint32_t uMajor;
    uint32_t uMinor;
    uint32_t uPatch;
...
typedef struct _plIO
{
    ...
    void  (*platform_new_frame)(void*);
    void  (*platform_cleanup)  (void*);
    void* pBackendPlatformData;

    // app functions (used by platform backends)
