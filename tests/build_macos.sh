...
echo
echo Project: ${MAGENTA}pilotlight_lib_tests${NC}
...
echo
echo ${YELLOW}Target: pilot_light_test_c${NC}
echo ${YELLOW}~~~~~~~~~~~~~~~~~~~${NC}
...
# run compiler (and linker)
echo
echo ${YELLOW}Target: pilot_light_test_cpp${NC}
echo ${YELLOW}~~~~~~~~~~~~~~~~~~~${NC}
echo ${CYAN}Compiling and Linking...${NC}
...
# run compiler (and linker)
echo
echo ${YELLOW}Target: tests_cpp${NC}
echo ${YELLOW}~~~~~~~~~~~~~~~~~~~${NC}
echo ${CYAN}Compiling and Linking...${NC}
