...
:: call compiler
cl %PL_INCLUDE_DIRECTORIES% %PL_DEFINES% %PL_COMPILER_FLAGS% %PL_SOURCES% -Fe"../out/pilot_light_test.exe" -Fo"../out/" -link -PDB:"../out/pilot_light_test_%random%.pdb" %PL_LINK_DIRECTORIES%
